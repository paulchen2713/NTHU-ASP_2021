...
for step_size_idx = 0.01 : 0.01 : step_size_max
    for L_idx = 3 : 2 : L_max
        ...
        static_1(step_size_pos_idx, (L_idx - 1) / 2, :) = APA_static(trainseq_static_1, data_static_1, L_idx, step_size_idx, M);
        %
...
for step_size_idx = 0.01 : 0.01 : step_size_max
    for L_idx = 3 : 2 : L_max
        step_size_pos_idx = round(step_size_idx*100); % floating point rounding error
        qstatic_1(step_size_pos_idx, (L_idx - 1) / 2, :) = APA_qstatic(trainseq_qstatic_1, data_qstatic_1, L_idx, step_size_idx, M);
        %
...
for step_size_idx = 0.01 : 0.01 : step_size_max
    for L_idx = 3 : 2 : L_max
        step_size_pos_idx = round(step_size_idx*100); % floating point rounding error
        varying_1(step_size_pos_idx, (L_idx - 1) / 2, :) = APA_varying(trainseq_varying_1, data_varying_1, L_idx, step_size_idx, M);
        %
...
%
ending_time = cputime;
time_tune_APA_M = ending_time - starting_time;
